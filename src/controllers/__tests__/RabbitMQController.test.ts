...
describe('RabbitMQController', () => {
  ...
  it('should throw an error if queue is undefined', () => {
    ...
    expect(() => controller.sendMessage(req, res)).toThrow('Fila undefined ou mensagem {"message":"test"} invalida');
  });
  ...
  it('should throw an error if message is undefined', () => {
    ...
    expect(() => controller.sendMessage(req, res)).toThrow('Fila undefined ou mensagem {"queue":"queue1"} invalida');
  });
  ...
  it('should throw an error if both queue and message are undefined', () => {
    ...
    expect(() => controller.sendMessage(req, res)).toThrow('Fila undefined ou mensagem {} invalida');
  });
  ...
  //   expect(res.json).toHaveBeenCalledWith({
  //     success: false,
  //     error: 'Fila undefined ou mensagem {"queue":"queue1","message":"hello"} invalida',
  //   });
  // });
});
